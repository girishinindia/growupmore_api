...
const controller = require('../controllers/social-medias.controller');
const { createSocialMediaSchema, updateSocialMediaSchema } = require('../validators/social-medias.validator');
