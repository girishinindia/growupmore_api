...
const controller = require('../controllers/sub-categories.controller');
const { createSubCategorySchema, updateSubCategorySchema } = require('../validators/sub-categories.validator');
