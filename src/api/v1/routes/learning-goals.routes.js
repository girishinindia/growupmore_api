...
const controller = require('../controllers/learning-goals.controller');
const { createLearningGoalSchema, updateLearningGoalSchema } = require('../validators/learning-goals.validator');
...
router.post(
  ...
  validate(createLearningGoalSchema),
...
router.put(
  ...
  validate(updateLearningGoalSchema),
