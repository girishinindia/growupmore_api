...
router.put('/countries/:id', authorize('country.update'), validate(idParamSchema, 'params'), uploadFlagImage, validate(updateCountrySchema), masterDataController.updateCountry);
...
router.put('/states/:id', authorize('state.update'), validate(idParamSchema, 'params'), validate(updateStateSchema), masterDataController.updateState);
...
router.put('/cities/:id', authorize('city.update'), validate(idParamSchema, 'params'), validate(updateCitySchema), masterDataController.updateCity);
