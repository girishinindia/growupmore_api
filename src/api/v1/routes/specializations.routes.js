...
const controller = require('../controllers/specializations.controller');
const { createSpecializationSchema, updateSpecializationSchema } = require('../validators/specializations.validator');
